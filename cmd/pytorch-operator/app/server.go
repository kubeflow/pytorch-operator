...
func Run(opt *options.ServerOption) error {
	...
	kubeClient, leaderElectionClient, pytorchJobClient, err := createClients(config)
	if err != nil {
		return err
	}
	...
	controller, err := controller.New(kubeClient, pytorchJobClient, *controllerConfig, pytorchJobInformerFactory)
	if err != nil {
		return err
	}
...
func createClients(config *rest.Config) (clientset.Interface, clientset.Interface, torchjobclient.Interface, error) {
	...
	return kubeClient, leaderElectionClient, pytorchJobClient, nil
}
