...
**spec** | [**V1PyTorchJobSpec**](V1PyTorchJobSpec.md) | Specification of the desired state of the PyTorchJob. | [optional] 
**status** | [**V1JobStatus**](V1JobStatus.md) | Most recently observed status of the PyTorchJob. Read-only (modified by the system). | [optional] 
