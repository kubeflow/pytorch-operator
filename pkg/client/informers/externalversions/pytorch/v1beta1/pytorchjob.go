...
import (
	...
	v1beta1 "github.com/kubeflow/pytorch-operator/pkg/client/listers/pytorch/v1beta1"
...
func (f *pyTorchJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pytorchv1beta1.PyTorchJob{}, f.defaultInformer)
}
