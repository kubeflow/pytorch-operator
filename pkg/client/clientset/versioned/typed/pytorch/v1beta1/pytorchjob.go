...
type PyTorchJobInterface interface {
	Create(*v1beta1.PyTorchJob) (*v1beta1.PyTorchJob, error)
	Update(*v1beta1.PyTorchJob) (*v1beta1.PyTorchJob, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.PyTorchJob, error)
	List(opts v1.ListOptions) (*v1beta1.PyTorchJobList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.PyTorchJob, err error)
	PyTorchJobExpansion
}
...
func newPyTorchJobs(c *KubeflowV1beta1Client, namespace string) *pyTorchJobs {
	return &pyTorchJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *pyTorchJobs) Get(name string, options v1.GetOptions) (result *v1beta1.PyTorchJob, err error) {
	result = &v1beta1.PyTorchJob{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *pyTorchJobs) List(opts v1.ListOptions) (result *v1beta1.PyTorchJobList, err error) {
	result = &v1beta1.PyTorchJobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pytorchjobs").
...
func (c *pyTorchJobs) Create(pyTorchJob *v1beta1.PyTorchJob) (result *v1beta1.PyTorchJob, err error) {
	result = &v1beta1.PyTorchJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pytorchjobs").
...
func (c *pyTorchJobs) Update(pyTorchJob *v1beta1.PyTorchJob) (result *v1beta1.PyTorchJob, err error) {
	result = &v1beta1.PyTorchJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pytorchjobs").
...
func (c *pyTorchJobs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.PyTorchJob, err error) {
	result = &v1beta1.PyTorchJob{}
