...
var pytorchjobsResource = schema.GroupVersionResource{Group: "kubeflow.org", Version: "v1beta1", Resource: "pytorchjobs"}

var pytorchjobsKind = schema.GroupVersionKind{Group: "kubeflow.org", Version: "v1beta1", Kind: "PyTorchJob"}
...
func (c *FakePyTorchJobs) Get(name string, options v1.GetOptions) (result *v1beta1.PyTorchJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(pytorchjobsResource, c.ns, name), &v1beta1.PyTorchJob{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.PyTorchJob), err
}
...
func (c *FakePyTorchJobs) List(opts v1.ListOptions) (result *v1beta1.PyTorchJobList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(pytorchjobsResource, pytorchjobsKind, c.ns, opts), &v1beta1.PyTorchJobList{})
	...
	list := &v1beta1.PyTorchJobList{ListMeta: obj.(*v1beta1.PyTorchJobList).ListMeta}
	for _, item := range obj.(*v1beta1.PyTorchJobList).Items {
...
func (c *FakePyTorchJobs) Create(pyTorchJob *v1beta1.PyTorchJob) (result *v1beta1.PyTorchJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(pytorchjobsResource, c.ns, pyTorchJob), &v1beta1.PyTorchJob{})
...
func (c *FakePyTorchJobs) Update(pyTorchJob *v1beta1.PyTorchJob) (result *v1beta1.PyTorchJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(pytorchjobsResource, c.ns, pyTorchJob), &v1beta1.PyTorchJob{})
...
func (c *FakePyTorchJobs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(pytorchjobsResource, c.ns, name), &v1beta1.PyTorchJob{})
...
func (c *FakePyTorchJobs) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.PyTorchJobList{})
	return err
}
...
func (c *FakePyTorchJobs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.PyTorchJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(pytorchjobsResource, c.ns, name, data, subresources...), &v1beta1.PyTorchJob{})
