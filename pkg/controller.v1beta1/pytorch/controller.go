...
type PyTorchController struct {
	...
	updateStatusHandler func(job *v1beta1.PyTorchJob) error

	// To allow injection of deletePyTorchJob for testing.
	deletePyTorchJobHandler func(job *v1beta1.PyTorchJob) error
...
func (pc *PyTorchController) reconcilePyTorchJobs(job *v1beta1.PyTorchJob) error {
...
// manager.
func (pc *PyTorchController) satisfiedExpectations(job *v1beta1.PyTorchJob) bool {
	satisfied := false
...
func (pc *PyTorchController) GetJobFromAPIClient(namespace, name string) (metav1.Object, error) {
	return pc.jobClientSet.KubeflowV1beta1().PyTorchJobs(namespace).Get(name, metav1.GetOptions{})
}

func (pc *PyTorchController) GetAPIGroupVersionKind() schema.GroupVersionKind {
	return v1beta1.SchemeGroupVersionKind
}

func (pc *PyTorchController) GetAPIGroupVersion() schema.GroupVersion {
	return v1beta1.SchemeGroupVersion
}
