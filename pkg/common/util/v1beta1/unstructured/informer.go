...
import (
	...
	informer "github.com/kubeflow/pytorch-operator/pkg/client/informers/externalversions/pytorch/v1beta1"
	lister "github.com/kubeflow/pytorch-operator/pkg/client/listers/pytorch/v1beta1"
)
