...
import (
	...
	joblisters "github.com/kubeflow/pytorch-operator/pkg/client/listers/kubeflow/v1alpha2"
...
func (pc *PyTorchController) GetJobFromAPIClient(namespace, name string) (metav1.Object, error) {
	return pc.jobClientSet.KubeflowV1alpha2().PyTorchJobs(namespace).Get(name, metav1.GetOptions{})
}
