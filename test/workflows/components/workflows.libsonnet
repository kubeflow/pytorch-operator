      ...
      local chart = srcDir + "/pytorch-operator-chart";
      {
        ...
        spec: {
          ...
          templates: [
            ...
            $.parts(namespace, name).e2e(prow_env, bucket).buildTemplate("delete-v1alpha2", testWorkerImage, [
            ...
            $.parts(namespace, name).e2e(prow_env, bucket).buildTemplate("delete-v1beta1", testWorkerImage, [
